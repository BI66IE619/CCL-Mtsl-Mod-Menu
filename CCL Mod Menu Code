...
.cheat:hover {
    ...
    footer.innerHTML = (`<span><br>Cheats by <a style="color: lightblue" href="https://github.com/BI66IE619">BI66IE619</a></span>`);
        ...
        global: {
            ...
            'Give Item': () => {
                async function checkGithubFile(Item) {
                    const response = await fetch('https://raw.githubusercontent.com/BI66IE619/CCL-Mtsl-Mod-Menu/main/ItemList.txt');
            ...
            'Inject Modded Game Script': () => {
                fetch('https://raw.githubusercontent.com/BI66IE619/CCL-Mtsl-Mod-Menu/main/GameScripts/ModdedGameScript.js')
                .then(response => {
                    if (!response.ok) {
